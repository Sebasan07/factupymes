...
@NamedQueries({
	...
	@NamedQuery(name="RangoNumeracion.findByEmpresa", query="SELECT r FROM rango_numeracion r where r.idNumeracion=(SELECT max(r.idNumeracion) from rango_numeracion r where r.empresa.nit=:nit)"),
