                            ...
                            <div class="card-body">
                                ...
                                <% Empresa e = request.getSession().getAttribute("empresa") != null
										...
										Cliente cl = (Cliente)request.getAttribute("cliente");
                                 		RangoNumeracion rg =(RangoNumeracion)request.getAttribute("rango");
                                 %>
                                    <!--Inicio campos del cliente-->
                                    <div class="input-box-numeracion">
                                         <span class="span_details">No.</span>
                                        <input type="hidden" name="rg" value="<%=rg.getIdNumeracion()%>">
                                        <input class="input_numeracion" type="number" name="rgNumero" value="<%=rg.getNumeroActual()%>" readonly>
                                    </div>
